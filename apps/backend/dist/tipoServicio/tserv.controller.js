...
function sanitizedTipoServicioInput(req, res, next) {
...
function add(req, res) {
    ...
    const tipoServicioInput = new TipoServicio(input.nombre, input.precio, input.id);
...
//# sourceMappingURL=tserv.controller.js.map