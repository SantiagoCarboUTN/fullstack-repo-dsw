...
export const Home = () => {
  ...
  return (
    <>
      <Navbar />
            {/* HERO */}
      <section className="bg-gray-200 flex flex-col-reverse lg:flex-row items-center justify-center py-16 lg:py-24 px-6 lg:px-20 text-center lg:text-left">
        {/* Texto */}
        ...
        {/* Imagen */}
        <div className="flex justify-center lg:justify-end w-full lg:w-1/2 mb-10 lg:mb-0">
          <img
            src={fotolandingpage}
            alt="estacionamiento"
            className="max-w-[300px] sm:max-w-[400px] lg:max-w-[480px] w-full h-auto transition-transform duration-300 hover:scale-105 animate-slide-in-right"
          />
        </div>
      </section>
      ...
      <section className="bg-gray-200 py-12">
        <h2 className="text-4xl lg:text-5xl font-bold text-center mb-10 text-blue-600">
          Servicios en alta demanda
        </h2>
    ...
    <footer className="bg-blue-900 text-white mt-0">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center lg:text-left">
        {/* Logo */}
        <div>
